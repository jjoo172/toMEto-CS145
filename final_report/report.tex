...
The rest of the paper is organized as follows. Section 2 contains how we obtained the data and other preprocessing steps. Section 3 describes the algorithms considered. Section 4 covers the app's web design and Section 5 covers the backend. Section 6 concludes our paper. 
