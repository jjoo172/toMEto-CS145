...
Larger scale version of (Figures 2-4):

\begin{figure}[H]
\centering
\includegraphics[width=0.879\textwidth]{p1.png}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.879\textwidth]{p2.png}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.879\textwidth]{p3.png}
\end{figure}
